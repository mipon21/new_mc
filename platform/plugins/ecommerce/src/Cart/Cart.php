...
use Botble\Ecommerce\Services\ShippingTaxCalculatorService;
use Carbon\Carbon;
...
class Cart
{
    ...
    public function rawShippingTax(float $shippingAmount): float
    {
        if (! EcommerceHelper::isTaxEnabled()) {
            return 0;
        }

        return app(ShippingTaxCalculatorService::class)->calculate($shippingAmount);
    }
}
