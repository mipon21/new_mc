    ...
    protected function stockStatusLabel(): Attribute
    {
        return Attribute::make(
            get: function (): ?string {
                ...
                if ($this->stock_status == StockStatusEnum::IN_STOCK_WITH_SHIPPING) {
                    return trans('plugins/ecommerce::products.stock_statuses.in_stock_with_shipping', [
                        'weeks' => $this->shipping_weeks
                    ]);
                }
    ...
    protected function stockStatusHtml(): Attribute
    {
        return Attribute::make(
            get: function (): ?string {
                ...
                if ($this->stock_status == StockStatusEnum::IN_STOCK_WITH_SHIPPING) {
                    return Html::tag('span', trans('plugins/ecommerce::products.stock_statuses.in_stock_with_shipping', [
                        'weeks' => $this->shipping_weeks
                    ]), ['class' => 'text-warning'])->toHtml();
                }
