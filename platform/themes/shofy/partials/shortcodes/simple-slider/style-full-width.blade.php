<section class="tp-slider-area p-relative z-index-1">
    <div class="tp-slider-full-width tp-slider-active tp-slider-variation swiper-container @if ($shortcode->animation_enabled == 'no') tp-slider-no-animation @endif"
        ...
        <div class="swiper-wrapper">
            @foreach ($sliders as $slider)
                ...
                <div @class(['tp-slider-item swiper-slide', 'is-light' => $slider->getMetaData('is_light', true)])
        ...
        @if(count($sliders) > 1)
            ...
            <div class="tp-slider-dot tp-swiper-dot d-none d-lg-block"></div>
        @endif
    </div>
</section>