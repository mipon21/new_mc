...
class NewsletterWidget extends AbstractWidget
{
    public function __construct()
    {
        parent::__construct([
            ...
            'note' => 'Angegebene E-Mails unterliegen unserem Datenschutzhinweis',
    ...
    protected function settingForm(): WidgetForm|string|null
    {
        $form = WidgetForm::createFromArray($this->getConfig())
            ...
            ->add(
                ...
                TextFieldOption::make()
                    ->label(__('Note'))
                    ->helperText(__('This note will appear below the email input.'))
                    ->defaultValue('Angegebene E-Mails unterliegen unserem Datenschutzhinweis'),
            )
            ->add(
                'background_image',
